...
static Vector2 g_terrain_offset = {0, 0};
static float g_terrain_world_w = 0.0f;
static float g_terrain_world_h = 0.0f;
static float g_terrain_render_scale = 1.0f;
